...
/datum/preferences
	...
	var/static/datum/patron/default_patron = /datum/patron/elemental/gani
...
//			-----------START OF BODY TABLE-----------
			...
			dat += "<br><b>Loadout Item:</b> <a href='?_src_=prefs;preference=loadout_item;task=input'>[loadout ? loadout2.name : "None"]</a>"
			dat += "<br><b>Loadout Item:</b> <a href='?_src_=prefs;preference=loadout_item;task=input'>[loadout ? loadout3.name : "None"]</a>"
...
//						age = max(min( round(text2num(new_age)), AGE_MAX),AGE_MIN)
				...
				if("ooc_notes")
					to_chat(user, "<span class='notice'>["<span class='bold'>These are currently pending an actual purpose. Please do not put anything in here yet.</span>"]</span>")
